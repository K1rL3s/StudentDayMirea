...
LOTTERY_INFO_TEXT = """
Чтобы поучаствовать в лотерее, нужно получить лотерейный билет и не забыть вписать своё ФИО, группу и персональный ID.
Для этого ищи точку в местах празднования:
